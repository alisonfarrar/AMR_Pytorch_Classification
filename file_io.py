...
def get_metadata(AKSEG_DIRECTORY, USER_INITIAL,
    ...
    akseg_metadata["channel_list"] = akseg_metadata["channel_list"].apply(
        lambda data: extract_list(data, mode="channel"))

    akseg_metadata["image_save_path"] = akseg_metadata["image_save_path"].apply(
        lambda path: update_akseg_paths(path, AKSEG_DIRECTORY, USER_INITIAL))
    akseg_metadata["mask_save_path"] = akseg_metadata["mask_save_path"].apply(
        lambda path: update_akseg_paths(path, AKSEG_DIRECTORY, USER_INITIAL))
    akseg_metadata["label_save_path"] = akseg_metadata["label_save_path"].apply(
        lambda path: update_akseg_paths(path, AKSEG_DIRECTORY, USER_INITIAL))
