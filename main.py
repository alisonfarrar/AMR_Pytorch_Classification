...
from file_io import get_metadata, get_training_data, cache_data, convert_antibiotics_to_strain
import pickle
...
MODEL_FOLDER_NAME = "SensRes20X_NewAug_L60725_A"
...
#akseg_metadata.to_csv('metadata_Carb_BioRepA.csv')
...
if __name__ == '__main__':
    ...
    #trainer.plot_descriptive_dataset_stats(show_plots=False, save_plots=True) # error with extra states like file name
